...
class AuthenticationTest extends TestCase
{
    ...
    public function test_login_screen_renders_masjid_branding(): void
    {
        $this->get('/login')
            ...
            ->assertDontSee('Pembelajaran Iqro, Alquran dan Hafalan')
            ->assertDontSee('Absensi sesi harian Senin–Jumat untuk semua santri aktif.')
            ->assertDontSee('Progress bacaan & hafalan disesuaikan jenis setoran.', false)
            ->assertDontSee('Barangsiapa menempuh suatu jalan untuk mencari ilmu')
