...
class OperationalDashboard
{
    ...
    public function for(User $user): array
    {
        ...
        $attendanceToday = $this->attendanceCountsToday($halaqahIds, $today, $year);
     ...
     */
    private function attendanceCountsToday(Collection $halaqahIds, string $today, ?AcademicYear $year): array
    {
        $counts = [
