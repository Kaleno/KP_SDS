<x-app-layout>
    <x-slot name="header">
        <h1 class="text-lg font-semibold text-slate-800">Tambah orang tua</h1>
    </x-slot>

    <form method="POST" action="{{ route('ketua.orang-tua.store') }}" class="max-w-xl bg-white rounded-xl border border-slate-200 p-5 grid gap-4">
        @csrf
        <div>
