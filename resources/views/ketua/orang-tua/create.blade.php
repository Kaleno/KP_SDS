<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="font-display text-2xl font-semibold text-teal-950">Tambah orang tua</h1>
        </div>
    </x-slot>

    <form method="POST" action="{{ route('ketua.orang-tua.store') }}" class="max-w-xl ui-card p-5 sm:p-6 grid gap-4">
        @csrf
        <div>
